...
const D3DCREATE_FPU_PRESERVE = cast(clong, &h00000002)
const D3DCREATE_MULTITHREADED = cast(clong, &h00000004)
const D3DCREATE_PUREDEVICE = cast(clong, &h00000010)
const D3DCREATE_SOFTWARE_VERTEXPROCESSING = cast(clong, &h00000020)
const D3DCREATE_HARDWARE_VERTEXPROCESSING = cast(clong, &h00000040)
const D3DCREATE_MIXED_VERTEXPROCESSING = cast(clong, &h00000080)
const D3DCREATE_DISABLE_DRIVER_MANAGEMENT = cast(clong, &h00000100)
const D3DCREATE_ADAPTERGROUP_DEVICE = cast(clong, &h00000200)
const D3DCREATE_DISABLE_DRIVER_MANAGEMENT_EX = cast(clong, &h00000400)
const D3DCREATE_NOWINDOWCHANGES = cast(clong, &h00000800)
const D3DCREATE_DISABLE_PSGP_THREADING = cast(clong, &h00002000)
const D3DCREATE_ENABLE_PRESENTSTATS = cast(clong, &h00004000)
const D3DCREATE_DISABLE_PRINTSCREEN = cast(clong, &h00008000)
const D3DCREATE_SCREENSAVER = cast(clong, &h10000000)
const D3DSPD_IUNKNOWN = cast(clong, &h00000001)
const D3D_SDK_VERSION = 32
const D3DADAPTER_DEFAULT = 0
const D3DENUM_NO_WHQL_LEVEL = cast(clong, &h00000002)
const D3DPRESENT_DONOTWAIT = cast(clong, 1)
const D3DPRESENT_LINEAR_CONTENT = cast(clong, 2)
const D3DPRESENT_BACK_BUFFERS_MAX = cast(clong, 3)
const D3DSGR_NO_CALIBRATION = cast(clong, &h00000000)
const D3DSGR_CALIBRATE = cast(clong, &h00000001)
const _FACD3D = &h876
