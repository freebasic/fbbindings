...
const AI_NUMERICHOST = &h00000004
	...
	#ifndef UNICODE
		declare function GetAddrInfo alias "getaddrinfo"(byval nodename as const zstring ptr, byval servname as const zstring ptr, byval hints as const addrinfo ptr, byval res as addrinfo ptr ptr) as long
	#endif
	...
	#ifndef UNICODE
		declare sub FreeAddrInfo alias "freeaddrinfo"(byval pAddrInfo as LPADDRINFO)
	#endif
#endif
...
type socklen_t as long
	...
	#ifndef UNICODE
		declare function GetNameInfo alias "getnameinfo"(byval sa as const SOCKADDR ptr, byval salen as socklen_t, byval host as zstring ptr, byval hostlen as DWORD, byval serv as zstring ptr, byval servlen as DWORD, byval flags as long) as long
	#endif
#endif
