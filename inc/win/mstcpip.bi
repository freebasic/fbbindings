...
#if (_WIN32_WINNT = &h0502) or (_WIN32_WINNT = &h0602)
	declare function RtlIpv4AddressToStringA(byval Addr as const IN_ADDR_ ptr, byval S as LPSTR) as LPSTR
	declare function RtlIpv4AddressToStringW(byval Addr as const IN_ADDR_ ptr, byval S as LPWSTR) as LPWSTR
#endif
...
#if (_WIN32_WINNT = &h0502) or (_WIN32_WINNT = &h0602)
	declare function RtlIpv4AddressToStringExA(byval Address as const IN_ADDR_ ptr, byval Port as USHORT, byval AddressString as LPSTR, byval AddressStringLength as PULONG) as LONG
	declare function RtlIpv4AddressToStringExW(byval Address as const IN_ADDR_ ptr, byval Port as USHORT, byval AddressString as LPWSTR, byval AddressStringLength as PULONG) as LONG
#endif
...
#if (_WIN32_WINNT = &h0502) or (_WIN32_WINNT = &h0602)
	declare function RtlIpv4StringToAddressA(byval S as PCSTR, byval Strict_ as BOOLEAN, byval Terminator as LPSTR ptr, byval Addr as IN_ADDR_ ptr) as LONG
	declare function RtlIpv4StringToAddressW(byval S as PCWSTR, byval Strict_ as BOOLEAN, byval Terminator as LPWSTR ptr, byval Addr as IN_ADDR_ ptr) as LONG
#endif
...
#if (_WIN32_WINNT = &h0502) or (_WIN32_WINNT = &h0602)
	declare function RtlIpv4StringToAddressExA(byval AddressString as PCSTR, byval Strict_ as BOOLEAN, byval Address as IN_ADDR_ ptr, byval Port as PUSHORT) as LONG
	declare function RtlIpv4StringToAddressExW(byval AddressString as PCWSTR, byval Strict_ as BOOLEAN, byval Address as IN_ADDR_ ptr, byval Port as PUSHORT) as LONG
#endif
