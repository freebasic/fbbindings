...
const IOF_SHOWHELP = cast(clong, &h00000001)
const IOF_SELECTCREATENEW = cast(clong, &h00000002)
const IOF_SELECTCREATEFROMFILE = cast(clong, &h00000004)
const IOF_CHECKLINK = cast(clong, &h00000008)
const IOF_CHECKDISPLAYASICON = cast(clong, &h00000010)
const IOF_CREATENEWOBJECT = cast(clong, &h00000020)
const IOF_CREATEFILEOBJECT = cast(clong, &h00000040)
const IOF_CREATELINKOBJECT = cast(clong, &h00000080)
const IOF_DISABLELINK = cast(clong, &h00000100)
const IOF_VERIFYSERVERSEXIST = cast(clong, &h00000200)
const IOF_DISABLEDISPLAYASICON = cast(clong, &h00000400)
const IOF_HIDECHANGEICON = cast(clong, &h00000800)
const IOF_SHOWINSERTCONTROL = cast(clong, &h00001000)
const IOF_SELECTCREATECONTROL = cast(clong, &h00002000)
...
const PSF_SHOWHELP = cast(clong, &h00000001)
const PSF_SELECTPASTE = cast(clong, &h00000002)
const PSF_SELECTPASTELINK = cast(clong, &h00000004)
const PSF_CHECKDISPLAYASICON = cast(clong, &h00000008)
const PSF_DISABLEDISPLAYASICON = cast(clong, &h00000010)
const PSF_HIDECHANGEICON = cast(clong, &h00000020)
const PSF_STAYONCLIPBOARDCHANGE = cast(clong, &h00000040)
const PSF_NOREFRESHDATAOBJECT = cast(clong, &h00000080)
...
const ELF_SHOWHELP = cast(clong, &h00000001)
const ELF_DISABLEUPDATENOW = cast(clong, &h00000002)
const ELF_DISABLEOPENSOURCE = cast(clong, &h00000004)
const ELF_DISABLECHANGESOURCE = cast(clong, &h00000008)
const ELF_DISABLECANCELLINK = cast(clong, &h00000010)
...
const CIF_SHOWHELP = cast(clong, &h00000001)
const CIF_SELECTCURRENT = cast(clong, &h00000002)
const CIF_SELECTDEFAULT = cast(clong, &h00000004)
const CIF_SELECTFROMFILE = cast(clong, &h00000008)
const CIF_USEICONEXE = cast(clong, &h00000010)
...
const CF_SHOWHELPBUTTON = cast(clong, &h00000001)
const CF_SETCONVERTDEFAULT = cast(clong, &h00000002)
const CF_SETACTIVATEDEFAULT = cast(clong, &h00000004)
const CF_SELECTCONVERTTO = cast(clong, &h00000008)
const CF_SELECTACTIVATEAS = cast(clong, &h00000010)
const CF_DISABLEDISPLAYASICON = cast(clong, &h00000020)
const CF_DISABLEACTIVATEAS = cast(clong, &h00000040)
const CF_HIDECHANGEICON = cast(clong, &h00000080)
const CF_CONVERTONLY = cast(clong, &h00000100)
...
const BZ_DISABLECANCELBUTTON = cast(clong, &h00000001)
const BZ_DISABLESWITCHTOBUTTON = cast(clong, &h00000002)
const BZ_DISABLERETRYBUTTON = cast(clong, &h00000004)
const BZ_NOTRESPONDINGDIALOG = cast(clong, &h00000008)
...
const CSF_SHOWHELP = cast(clong, &h00000001)
const CSF_VALIDSOURCE = cast(clong, &h00000002)
const CSF_ONLYGETSOURCE = cast(clong, &h00000004)
const CSF_EXPLORER = cast(clong, &h00000008)
...
const VPF_SELECTRELATIVE = cast(clong, &h00000001)
const VPF_DISABLERELATIVE = cast(clong, &h00000002)
const VPF_DISABLESCALE = cast(clong, &h00000004)
...
const OPF_OBJECTISLINK = cast(clong, &h00000001)
const OPF_NOFILLDEFAULT = cast(clong, &h00000002)
const OPF_SHOWHELP = cast(clong, &h00000004)
const OPF_DISABLECONVERT = cast(clong, &h00000008)
