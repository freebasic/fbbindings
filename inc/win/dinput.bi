...
const DI_POLLEDDEVICE = cast(HRESULT, cast(clong, &h00000002))
const DI_DOWNLOADSKIPPED = cast(HRESULT, cast(clong, &h00000003))
const DI_EFFECTRESTARTED = cast(HRESULT, cast(clong, &h00000004))
const DI_TRUNCATED = cast(HRESULT, cast(clong, &h00000008))
const DI_SETTINGSNOTSAVED = cast(HRESULT, cast(clong, &h0000000B))
const DI_TRUNCATEDANDRESTARTED = cast(HRESULT, cast(clong, &h0000000C))
const DI_WRITEPROTECT = cast(HRESULT, cast(clong, &h00000013))
