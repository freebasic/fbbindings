...
const CRL_DIST_POINT_ERR_CRL_ISSUER_BIT = cast(clong, &h80000000)
...
const CERT_EXCLUDED_SUBTREE_BIT = cast(clong, &h80000000)
...
const CMSG_ALL_FLAGS = not cast(culong, 0)
...
const CERT_STORE_ALL_CONTEXT_FLAG = not cast(culong, 0)
