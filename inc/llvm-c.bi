...
declare function LLVMPointerSizeForAS(byval TD as LLVMTargetDataRef, byval AS as ulong) as ulong
declare function LLVMIntPtrType(byval TD as LLVMTargetDataRef) as LLVMTypeRef
declare function LLVMIntPtrTypeForAS(byval TD as LLVMTargetDataRef, byval AS as ulong) as LLVMTypeRef
declare function LLVMIntPtrTypeInContext(byval C as LLVMContextRef, byval TD as LLVMTargetDataRef) as LLVMTypeRef
declare function LLVMIntPtrTypeForASInContext(byval C as LLVMContextRef, byval TD as LLVMTargetDataRef, byval AS as ulong) as LLVMTypeRef
...
declare function lto_module_get_num_deplibs(byval mod as lto_module_t) as ulong
declare function lto_module_get_deplib(byval mod as lto_module_t, byval index as ulong) as const zstring ptr
declare function lto_module_get_num_linkeropts(byval mod as lto_module_t) as ulong
declare function lto_module_get_linkeropt(byval mod as lto_module_t, byval index as ulong) as const zstring ptr
