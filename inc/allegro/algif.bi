...
declare function load_gif(byval filename as const zstring ptr, byval pal as RGB_ ptr) as BITMAP ptr
declare function save_gif(byval filename as const zstring ptr, byval bmp as BITMAP ptr, byval pal as const RGB_ ptr) as long
