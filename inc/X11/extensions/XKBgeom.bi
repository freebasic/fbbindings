...
#define XkbShapeDoodadColor(g, d) '' TODO: (&(g)->colors[(d)->color_ndx])
#define XkbShapeDoodadShape(g, d) '' TODO: (&(g)->shapes[(d)->shape_ndx])
#define XkbSetShapeDoodadColor(g, d, c) '' TODO: ((d)->color_ndx= (c)-&(g)->colors[0])
#define XkbSetShapeDoodadShape(g, d, s) '' TODO: ((d)->shape_ndx= (s)-&(g)->shapes[0])
...
#define XkbTextDoodadColor(g, d) '' TODO: (&(g)->colors[(d)->color_ndx])
#define XkbSetTextDoodadColor(g, d, c) '' TODO: ((d)->color_ndx= (c)-&(g)->colors[0])
...
#define XkbIndicatorDoodadShape(g, d) '' TODO: (&(g)->shapes[(d)->shape_ndx])
#define XkbIndicatorDoodadOnColor(g, d) '' TODO: (&(g)->colors[(d)->on_color_ndx])
#define XkbIndicatorDoodadOffColor(g, d) '' TODO: (&(g)->colors[(d)->off_color_ndx])
#define XkbSetIndicatorDoodadOnColor(g, d, c) '' TODO: ((d)->on_color_ndx= (c)-&(g)->colors[0])
#define XkbSetIndicatorDoodadOffColor(g, d, c) '' TODO: ((d)->off_color_ndx= (c)-&(g)->colors[0])
#define XkbSetIndicatorDoodadShape(g, d, s) '' TODO: ((d)->shape_ndx= (s)-&(g)->shapes[0])
...
#define XkbLogoDoodadColor(g, d) '' TODO: (&(g)->colors[(d)->color_ndx])
#define XkbLogoDoodadShape(g, d) '' TODO: (&(g)->shapes[(d)->shape_ndx])
#define XkbSetLogoDoodadColor(g, d, c) '' TODO: ((d)->color_ndx= (c)-&(g)->colors[0])
#define XkbSetLogoDoodadShape(g, d, s) '' TODO: ((d)->shape_ndx= (s)-&(g)->shapes[0])
...
#define XkbKeyShape(g, k) '' TODO: (&(g)->shapes[(k)->shape_ndx])
#define XkbKeyColor(g, k) '' TODO: (&(g)->colors[(k)->color_ndx])
#define XkbSetKeyShape(g, k, s) '' TODO: ((k)->shape_ndx= (s)-&(g)->shapes[0])
#define XkbSetKeyColor(g, k, c) '' TODO: ((k)->color_ndx= (c)-&(g)->colors[0])
...
declare function XkbAddGeomShape(byval as XkbGeometryPtr, byval as Atom, byval as long) as XkbShapePtr
...
declare function XkbAddGeomSection(byval as XkbGeometryPtr, byval as Atom, byval as long, byval as long, byval as long) as XkbSectionPtr
declare function XkbAddGeomOverlay(byval as XkbSectionPtr, byval as Atom, byval as long) as XkbOverlayPtr
...
declare function XkbAddGeomDoodad(byval as XkbGeometryPtr, byval as XkbSectionPtr, byval as Atom) as XkbDoodadPtr
...
declare function XkbGetNamedGeometry(byval as Display ptr, byval as XkbDescPtr, byval as Atom) as long
