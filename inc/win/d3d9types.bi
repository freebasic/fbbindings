...
const D3DCLEAR_TARGET = cast(clong, &h00000001)
const D3DCLEAR_ZBUFFER = cast(clong, &h00000002)
const D3DCLEAR_STENCIL = cast(clong, &h00000004)
...
const D3DCS_LEFT = cast(clong, &h001)
const D3DCS_RIGHT = cast(clong, &h002)
const D3DCS_TOP = cast(clong, &h004)
const D3DCS_BOTTOM = cast(clong, &h008)
const D3DCS_FRONT = cast(clong, &h010)
const D3DCS_BACK = cast(clong, &h020)
const D3DCS_PLANE0 = cast(clong, &h040)
const D3DCS_PLANE1 = cast(clong, &h080)
const D3DCS_PLANE2 = cast(clong, &h100)
const D3DCS_PLANE3 = cast(clong, &h200)
const D3DCS_PLANE4 = cast(clong, &h400)
const D3DCS_PLANE5 = cast(clong, &h800)
const D3DCS_ALL = cast(clong, &hFFF)
...
const D3DUSAGE_RENDERTARGET = cast(clong, &h00000001)
const D3DUSAGE_DEPTHSTENCIL = cast(clong, &h00000002)
const D3DUSAGE_WRITEONLY = cast(clong, &h00000008)
const D3DUSAGE_SOFTWAREPROCESSING = cast(clong, &h00000010)
const D3DUSAGE_DONOTCLIP = cast(clong, &h00000020)
const D3DUSAGE_POINTS = cast(clong, &h00000040)
const D3DUSAGE_RTPATCHES = cast(clong, &h00000080)
const D3DUSAGE_NPATCHES = cast(clong, &h00000100)
const D3DUSAGE_DYNAMIC = cast(clong, &h00000200)
const D3DUSAGE_AUTOGENMIPMAP = cast(clong, &h00000400)
const D3DUSAGE_DMAP = cast(clong, &h00004000)
const D3DUSAGE_QUERY_FILTER = cast(clong, &h00020000)
const D3DUSAGE_QUERY_LEGACYBUMPMAP = cast(clong, &h00008000)
const D3DUSAGE_QUERY_POSTPIXELSHADER_BLENDING = cast(clong, &h00080000)
const D3DUSAGE_QUERY_SRGBREAD = cast(clong, &h00010000)
const D3DUSAGE_QUERY_SRGBWRITE = cast(clong, &h00040000)
const D3DUSAGE_QUERY_VERTEXTEXTURE = cast(clong, &h00100000)
const D3DUSAGE_QUERY_WRAPANDMIP = cast(clong, &h00200000)
const D3DWRAP_U = 1
const D3DWRAP_V = 2
const D3DWRAP_W = 4
...
const D3DCOLORWRITEENABLE_RED = cast(clong, 1) shl 0
const D3DCOLORWRITEENABLE_GREEN = cast(clong, 1) shl 1
const D3DCOLORWRITEENABLE_BLUE = cast(clong, 1) shl 2
const D3DCOLORWRITEENABLE_ALPHA = cast(clong, 1) shl 3
