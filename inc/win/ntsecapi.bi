...
const LSA_MODE_PASSWORD_PROTECTED = cast(clong, &h00000001)
const LSA_MODE_INDIVIDUAL_ACCOUNTS = cast(clong, &h00000002)
const LSA_MODE_MANDATORY_ACCESS = cast(clong, &h00000004)
const LSA_MODE_LOG_FULL = cast(clong, &h00000008)
...
const POLICY_AUDIT_EVENT_UNCHANGED = cast(clong, &h00000000)
const POLICY_AUDIT_EVENT_SUCCESS = cast(clong, &h00000001)
const POLICY_AUDIT_EVENT_FAILURE = cast(clong, &h00000002)
const POLICY_AUDIT_EVENT_NONE = cast(clong, &h00000004)
...
const POLICY_VIEW_LOCAL_INFORMATION = cast(clong, &h00000001)
const POLICY_VIEW_AUDIT_INFORMATION = cast(clong, &h00000002)
const POLICY_GET_PRIVATE_INFORMATION = cast(clong, &h00000004)
const POLICY_TRUST_ADMIN = cast(clong, &h00000008)
const POLICY_CREATE_ACCOUNT = cast(clong, &h00000010)
const POLICY_CREATE_SECRET = cast(clong, &h00000020)
const POLICY_CREATE_PRIVILEGE = cast(clong, &h00000040)
const POLICY_SET_DEFAULT_QUOTA_LIMITS = cast(clong, &h00000080)
const POLICY_SET_AUDIT_REQUIREMENTS = cast(clong, &h00000100)
const POLICY_AUDIT_LOG_ADMIN = cast(clong, &h00000200)
const POLICY_SERVER_ADMIN = cast(clong, &h00000400)
const POLICY_LOOKUP_NAMES = cast(clong, &h00000800)
const POLICY_NOTIFICATION = cast(clong, &h00001000)
...
const LSA_FTRECORD_DISABLED_REASONS = cast(clong, &h0000FFFF)
const LSA_TLN_DISABLED_NEW = cast(clong, &h00000001)
const LSA_TLN_DISABLED_ADMIN = cast(clong, &h00000002)
const LSA_TLN_DISABLED_CONFLICT = cast(clong, &h00000004)
const LSA_SID_DISABLED_ADMIN = cast(clong, &h00000001)
const LSA_SID_DISABLED_CONFLICT = cast(clong, &h00000002)
const LSA_NB_DISABLED_ADMIN = cast(clong, &h00000004)
const LSA_NB_DISABLED_CONFLICT = cast(clong, &h00000008)
...
const DOMAIN_PASSWORD_COMPLEX = cast(clong, &h00000001)
const DOMAIN_PASSWORD_NO_ANON_CHANGE = cast(clong, &h00000002)
const DOMAIN_PASSWORD_NO_CLEAR_CHANGE = cast(clong, &h00000004)
const DOMAIN_LOCKOUT_ADMINS = cast(clong, &h00000008)
const DOMAIN_PASSWORD_STORE_CLEARTEXT = cast(clong, &h00000010)
const DOMAIN_REFUSE_PASSWORD_CHANGE = cast(clong, &h00000020)
