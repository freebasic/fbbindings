...
const CALLBACK_TYPEMASK = cast(clong, &h00070000)
const CALLBACK_NULL = cast(clong, &h00000000)
const CALLBACK_WINDOW = cast(clong, &h00010000)
const CALLBACK_TASK = cast(clong, &h00020000)
const CALLBACK_FUNCTION = cast(clong, &h00030000)
const CALLBACK_THREAD = CALLBACK_TASK
const CALLBACK_EVENT = cast(clong, &h00050000)
...
const SND_NOWAIT = cast(clong, &h00002000)
const SND_ALIAS = cast(clong, &h00010000)
const SND_ALIAS_ID = cast(clong, &h00110000)
const SND_FILENAME = cast(clong, &h00020000)
const SND_RESOURCE = cast(clong, &h00040004)
...
const MIDI_IO_STATUS = cast(clong, &h00000020)
...
const MEVT_F_SHORT = cast(clong, &h00000000)
const MEVT_F_LONG = cast(clong, &h80000000)
const MEVT_F_CALLBACK = cast(clong, &h40000000)
...
const MIDIPROP_SET = cast(clong, &h80000000)
const MIDIPROP_GET = cast(clong, &h40000000)
const MIDIPROP_TIMEDIV = cast(clong, &h00000001)
const MIDIPROP_TEMPO = cast(clong, &h00000002)
...
const MIXERLINE_LINEF_ACTIVE = cast(clong, &h00000001)
const MIXERLINE_LINEF_DISCONNECTED = cast(clong, &h00008000)
const MIXERLINE_LINEF_SOURCE = cast(clong, &h80000000)
const MIXERLINE_COMPONENTTYPE_DST_FIRST = cast(clong, &h0)
...
const MIXERLINE_COMPONENTTYPE_SRC_FIRST = cast(clong, &h00001000)
...
const MIXER_GETLINEINFOF_DESTINATION = cast(clong, &h00000000)
const MIXER_GETLINEINFOF_SOURCE = cast(clong, &h00000001)
const MIXER_GETLINEINFOF_LINEID = cast(clong, &h00000002)
const MIXER_GETLINEINFOF_COMPONENTTYPE = cast(clong, &h00000003)
const MIXER_GETLINEINFOF_TARGETTYPE = cast(clong, &h00000004)
const MIXER_GETLINEINFOF_QUERYMASK = cast(clong, &h0000000F)
...
const MIXERCONTROL_CONTROLF_UNIFORM = cast(clong, &h00000001)
const MIXERCONTROL_CONTROLF_MULTIPLE = cast(clong, &h00000002)
const MIXERCONTROL_CONTROLF_DISABLED = cast(clong, &h80000000)
const MIXERCONTROL_CT_CLASS_MASK = cast(clong, &hF0000000)
const MIXERCONTROL_CT_CLASS_CUSTOM = cast(clong, &h00000000)
const MIXERCONTROL_CT_CLASS_METER = cast(clong, &h10000000)
const MIXERCONTROL_CT_CLASS_SWITCH = cast(clong, &h20000000)
const MIXERCONTROL_CT_CLASS_NUMBER = cast(clong, &h30000000)
const MIXERCONTROL_CT_CLASS_SLIDER = cast(clong, &h40000000)
const MIXERCONTROL_CT_CLASS_FADER = cast(clong, &h50000000)
const MIXERCONTROL_CT_CLASS_TIME = cast(clong, &h60000000)
const MIXERCONTROL_CT_CLASS_LIST = cast(clong, &h70000000)
const MIXERCONTROL_CT_SUBCLASS_MASK = cast(clong, &h0F000000)
const MIXERCONTROL_CT_SC_SWITCH_BOOLEAN = cast(clong, &h00000000)
const MIXERCONTROL_CT_SC_SWITCH_BUTTON = cast(clong, &h01000000)
const MIXERCONTROL_CT_SC_METER_POLLED = cast(clong, &h00000000)
const MIXERCONTROL_CT_SC_TIME_MICROSECS = cast(clong, &h00000000)
const MIXERCONTROL_CT_SC_TIME_MILLISECS = cast(clong, &h01000000)
const MIXERCONTROL_CT_SC_LIST_SINGLE = cast(clong, &h00000000)
const MIXERCONTROL_CT_SC_LIST_MULTIPLE = cast(clong, &h01000000)
const MIXERCONTROL_CT_UNITS_MASK = cast(clong, &h00FF0000)
const MIXERCONTROL_CT_UNITS_CUSTOM = cast(clong, &h00000000)
const MIXERCONTROL_CT_UNITS_BOOLEAN = cast(clong, &h00010000)
const MIXERCONTROL_CT_UNITS_SIGNED = cast(clong, &h00020000)
const MIXERCONTROL_CT_UNITS_UNSIGNED = cast(clong, &h00030000)
const MIXERCONTROL_CT_UNITS_DECIBELS = cast(clong, &h00040000)
const MIXERCONTROL_CT_UNITS_PERCENT = cast(clong, &h00050000)
...
const MIXER_GETLINECONTROLSF_ALL = cast(clong, &h00000000)
const MIXER_GETLINECONTROLSF_ONEBYID = cast(clong, &h00000001)
const MIXER_GETLINECONTROLSF_ONEBYTYPE = cast(clong, &h00000002)
const MIXER_GETLINECONTROLSF_QUERYMASK = cast(clong, &h0000000F)
...
const MIXER_GETCONTROLDETAILSF_VALUE = cast(clong, &h00000000)
const MIXER_GETCONTROLDETAILSF_LISTTEXT = cast(clong, &h00000001)
const MIXER_GETCONTROLDETAILSF_QUERYMASK = cast(clong, &h0000000F)
...
const MIXER_SETCONTROLDETAILSF_VALUE = cast(clong, &h00000000)
const MIXER_SETCONTROLDETAILSF_CUSTOM = cast(clong, &h00000001)
const MIXER_SETCONTROLDETAILSF_QUERYMASK = cast(clong, &h0000000F)
...
const JOY_BUTTON5 = cast(clong, &h00000010)
const JOY_BUTTON6 = cast(clong, &h00000020)
const JOY_BUTTON7 = cast(clong, &h00000040)
const JOY_BUTTON8 = cast(clong, &h00000080)
const JOY_BUTTON9 = cast(clong, &h00000100)
const JOY_BUTTON10 = cast(clong, &h00000200)
const JOY_BUTTON11 = cast(clong, &h00000400)
const JOY_BUTTON12 = cast(clong, &h00000800)
const JOY_BUTTON13 = cast(clong, &h00001000)
const JOY_BUTTON14 = cast(clong, &h00002000)
const JOY_BUTTON15 = cast(clong, &h00004000)
const JOY_BUTTON16 = cast(clong, &h00008000)
const JOY_BUTTON17 = cast(clong, &h00010000)
const JOY_BUTTON18 = cast(clong, &h00020000)
const JOY_BUTTON19 = cast(clong, &h00040000)
const JOY_BUTTON20 = cast(clong, &h00080000)
const JOY_BUTTON21 = cast(clong, &h00100000)
const JOY_BUTTON22 = cast(clong, &h00200000)
const JOY_BUTTON23 = cast(clong, &h00400000)
const JOY_BUTTON24 = cast(clong, &h00800000)
const JOY_BUTTON25 = cast(clong, &h01000000)
const JOY_BUTTON26 = cast(clong, &h02000000)
const JOY_BUTTON27 = cast(clong, &h04000000)
const JOY_BUTTON28 = cast(clong, &h08000000)
const JOY_BUTTON29 = cast(clong, &h10000000)
const JOY_BUTTON30 = cast(clong, &h20000000)
const JOY_BUTTON31 = cast(clong, &h40000000)
const JOY_BUTTON32 = cast(clong, &h80000000)
...
const JOY_RETURNX = cast(clong, &h00000001)
const JOY_RETURNY = cast(clong, &h00000002)
const JOY_RETURNZ = cast(clong, &h00000004)
const JOY_RETURNR = cast(clong, &h00000008)
const JOY_RETURNU = cast(clong, &h00000010)
const JOY_RETURNV = cast(clong, &h00000020)
const JOY_RETURNPOV = cast(clong, &h00000040)
const JOY_RETURNBUTTONS = cast(clong, &h00000080)
const JOY_RETURNRAWDATA = cast(clong, &h00000100)
const JOY_RETURNPOVCTS = cast(clong, &h00000200)
const JOY_RETURNCENTERED = cast(clong, &h00000400)
const JOY_USEDEADZONE = cast(clong, &h00000800)
...
const JOY_CAL_READALWAYS = cast(clong, &h00010000)
const JOY_CAL_READXYONLY = cast(clong, &h00020000)
const JOY_CAL_READ3 = cast(clong, &h00040000)
const JOY_CAL_READ4 = cast(clong, &h00080000)
const JOY_CAL_READXONLY = cast(clong, &h00100000)
const JOY_CAL_READYONLY = cast(clong, &h00200000)
const JOY_CAL_READ5 = cast(clong, &h00400000)
const JOY_CAL_READ6 = cast(clong, &h00800000)
const JOY_CAL_READZONLY = cast(clong, &h01000000)
const JOY_CAL_READRONLY = cast(clong, &h02000000)
const JOY_CAL_READUONLY = cast(clong, &h04000000)
const JOY_CAL_READVONLY = cast(clong, &h08000000)
const JOYSTICKID1 = 0
const JOYSTICKID2 = 1
...
const MCI_NOTIFY = cast(clong, &h00000001)
const MCI_WAIT = cast(clong, &h00000002)
const MCI_FROM = cast(clong, &h00000004)
const MCI_TO = cast(clong, &h00000008)
const MCI_TRACK = cast(clong, &h00000010)
const MCI_OPEN_SHAREABLE = cast(clong, &h00000100)
const MCI_OPEN_ELEMENT = cast(clong, &h00000200)
const MCI_OPEN_ALIAS = cast(clong, &h00000400)
const MCI_OPEN_ELEMENT_ID = cast(clong, &h00000800)
const MCI_OPEN_TYPE_ID = cast(clong, &h00001000)
const MCI_OPEN_TYPE = cast(clong, &h00002000)
const MCI_SEEK_TO_START = cast(clong, &h00000100)
const MCI_SEEK_TO_END = cast(clong, &h00000200)
const MCI_STATUS_ITEM = cast(clong, &h00000100)
const MCI_STATUS_START = cast(clong, &h00000200)
const MCI_STATUS_LENGTH = cast(clong, &h00000001)
const MCI_STATUS_POSITION = cast(clong, &h00000002)
const MCI_STATUS_NUMBER_OF_TRACKS = cast(clong, &h00000003)
const MCI_STATUS_MODE = cast(clong, &h00000004)
const MCI_STATUS_MEDIA_PRESENT = cast(clong, &h00000005)
const MCI_STATUS_TIME_FORMAT = cast(clong, &h00000006)
const MCI_STATUS_READY = cast(clong, &h00000007)
const MCI_STATUS_CURRENT_TRACK = cast(clong, &h00000008)
const MCI_INFO_PRODUCT = cast(clong, &h00000100)
const MCI_INFO_FILE = cast(clong, &h00000200)
const MCI_INFO_MEDIA_UPC = cast(clong, &h00000400)
const MCI_INFO_MEDIA_IDENTITY = cast(clong, &h00000800)
const MCI_INFO_NAME = cast(clong, &h00001000)
const MCI_INFO_COPYRIGHT = cast(clong, &h00002000)
const MCI_GETDEVCAPS_ITEM = cast(clong, &h00000100)
const MCI_GETDEVCAPS_CAN_RECORD = cast(clong, &h00000001)
const MCI_GETDEVCAPS_HAS_AUDIO = cast(clong, &h00000002)
const MCI_GETDEVCAPS_HAS_VIDEO = cast(clong, &h00000003)
const MCI_GETDEVCAPS_DEVICE_TYPE = cast(clong, &h00000004)
const MCI_GETDEVCAPS_USES_FILES = cast(clong, &h00000005)
const MCI_GETDEVCAPS_COMPOUND_DEVICE = cast(clong, &h00000006)
const MCI_GETDEVCAPS_CAN_EJECT = cast(clong, &h00000007)
const MCI_GETDEVCAPS_CAN_PLAY = cast(clong, &h00000008)
const MCI_GETDEVCAPS_CAN_SAVE = cast(clong, &h00000009)
const MCI_SYSINFO_QUANTITY = cast(clong, &h00000100)
const MCI_SYSINFO_OPEN = cast(clong, &h00000200)
const MCI_SYSINFO_NAME = cast(clong, &h00000400)
const MCI_SYSINFO_INSTALLNAME = cast(clong, &h00000800)
const MCI_SET_DOOR_OPEN = cast(clong, &h00000100)
const MCI_SET_DOOR_CLOSED = cast(clong, &h00000200)
const MCI_SET_TIME_FORMAT = cast(clong, &h00000400)
const MCI_SET_AUDIO = cast(clong, &h00000800)
const MCI_SET_VIDEO = cast(clong, &h00001000)
const MCI_SET_ON = cast(clong, &h00002000)
const MCI_SET_OFF = cast(clong, &h00004000)
const MCI_SET_AUDIO_ALL = cast(clong, &h00000000)
const MCI_SET_AUDIO_LEFT = cast(clong, &h00000001)
const MCI_SET_AUDIO_RIGHT = cast(clong, &h00000002)
const MCI_BREAK_KEY = cast(clong, &h00000100)
const MCI_BREAK_HWND = cast(clong, &h00000200)
const MCI_BREAK_OFF = cast(clong, &h00000400)
const MCI_RECORD_INSERT = cast(clong, &h00000100)
const MCI_RECORD_OVERWRITE = cast(clong, &h00000200)
const MCI_SAVE_FILE = cast(clong, &h00000100)
const MCI_LOAD_FILE = cast(clong, &h00000100)
...
const MCI_VD_PLAY_REVERSE = cast(clong, &h00010000)
const MCI_VD_PLAY_FAST = cast(clong, &h00020000)
const MCI_VD_PLAY_SPEED = cast(clong, &h00040000)
const MCI_VD_PLAY_SCAN = cast(clong, &h00080000)
const MCI_VD_PLAY_SLOW = cast(clong, &h00100000)
const MCI_VD_SEEK_REVERSE = cast(clong, &h00010000)
const MCI_VD_STATUS_SPEED = cast(clong, &h00004002)
const MCI_VD_STATUS_FORWARD = cast(clong, &h00004003)
const MCI_VD_STATUS_MEDIA_TYPE = cast(clong, &h00004004)
const MCI_VD_STATUS_SIDE = cast(clong, &h00004005)
const MCI_VD_STATUS_DISC_SIZE = cast(clong, &h00004006)
const MCI_VD_GETDEVCAPS_CLV = cast(clong, &h00010000)
const MCI_VD_GETDEVCAPS_CAV = cast(clong, &h00020000)
const MCI_VD_SPIN_UP = cast(clong, &h00010000)
const MCI_VD_SPIN_DOWN = cast(clong, &h00020000)
const MCI_VD_GETDEVCAPS_CAN_REVERSE = cast(clong, &h00004002)
const MCI_VD_GETDEVCAPS_FAST_RATE = cast(clong, &h00004003)
const MCI_VD_GETDEVCAPS_SLOW_RATE = cast(clong, &h00004004)
const MCI_VD_GETDEVCAPS_NORMAL_RATE = cast(clong, &h00004005)
const MCI_VD_STEP_FRAMES = cast(clong, &h00010000)
const MCI_VD_STEP_REVERSE = cast(clong, &h00020000)
const MCI_VD_ESCAPE_STRING = cast(clong, &h00000100)
...
const MCI_CDA_STATUS_TYPE_TRACK = cast(clong, &h00004001)
...
const MCI_WAVE_OPEN_BUFFER = cast(clong, &h00010000)
const MCI_WAVE_SET_FORMATTAG = cast(clong, &h00010000)
const MCI_WAVE_SET_CHANNELS = cast(clong, &h00020000)
const MCI_WAVE_SET_SAMPLESPERSEC = cast(clong, &h00040000)
const MCI_WAVE_SET_AVGBYTESPERSEC = cast(clong, &h00080000)
const MCI_WAVE_SET_BLOCKALIGN = cast(clong, &h00100000)
const MCI_WAVE_SET_BITSPERSAMPLE = cast(clong, &h00200000)
const MCI_WAVE_INPUT = cast(clong, &h00400000)
const MCI_WAVE_OUTPUT = cast(clong, &h00800000)
const MCI_WAVE_STATUS_FORMATTAG = cast(clong, &h00004001)
const MCI_WAVE_STATUS_CHANNELS = cast(clong, &h00004002)
const MCI_WAVE_STATUS_SAMPLESPERSEC = cast(clong, &h00004003)
const MCI_WAVE_STATUS_AVGBYTESPERSEC = cast(clong, &h00004004)
const MCI_WAVE_STATUS_BLOCKALIGN = cast(clong, &h00004005)
const MCI_WAVE_STATUS_BITSPERSAMPLE = cast(clong, &h00004006)
const MCI_WAVE_STATUS_LEVEL = cast(clong, &h00004007)
const MCI_WAVE_SET_ANYINPUT = cast(clong, &h04000000)
const MCI_WAVE_SET_ANYOUTPUT = cast(clong, &h08000000)
const MCI_WAVE_GETDEVCAPS_INPUTS = cast(clong, &h00004001)
const MCI_WAVE_GETDEVCAPS_OUTPUTS = cast(clong, &h00004002)
...
const MCI_SEQ_STATUS_TEMPO = cast(clong, &h00004002)
const MCI_SEQ_STATUS_PORT = cast(clong, &h00004003)
const MCI_SEQ_STATUS_SLAVE = cast(clong, &h00004007)
const MCI_SEQ_STATUS_MASTER = cast(clong, &h00004008)
const MCI_SEQ_STATUS_OFFSET = cast(clong, &h00004009)
const MCI_SEQ_STATUS_DIVTYPE = cast(clong, &h0000400A)
const MCI_SEQ_STATUS_NAME = cast(clong, &h0000400B)
const MCI_SEQ_STATUS_COPYRIGHT = cast(clong, &h0000400C)
const MCI_SEQ_SET_TEMPO = cast(clong, &h00010000)
const MCI_SEQ_SET_PORT = cast(clong, &h00020000)
const MCI_SEQ_SET_SLAVE = cast(clong, &h00040000)
const MCI_SEQ_SET_MASTER = cast(clong, &h00080000)
const MCI_SEQ_SET_OFFSET = cast(clong, &h01000000)
...
const MCI_ANIM_OPEN_WS = cast(clong, &h00010000)
const MCI_ANIM_OPEN_PARENT = cast(clong, &h00020000)
const MCI_ANIM_OPEN_NOSTATIC = cast(clong, &h00040000)
const MCI_ANIM_PLAY_SPEED = cast(clong, &h00010000)
const MCI_ANIM_PLAY_REVERSE = cast(clong, &h00020000)
const MCI_ANIM_PLAY_FAST = cast(clong, &h00040000)
const MCI_ANIM_PLAY_SLOW = cast(clong, &h00080000)
const MCI_ANIM_PLAY_SCAN = cast(clong, &h00100000)
const MCI_ANIM_STEP_REVERSE = cast(clong, &h00010000)
const MCI_ANIM_STEP_FRAMES = cast(clong, &h00020000)
const MCI_ANIM_STATUS_SPEED = cast(clong, &h00004001)
const MCI_ANIM_STATUS_FORWARD = cast(clong, &h00004002)
const MCI_ANIM_STATUS_HWND = cast(clong, &h00004003)
const MCI_ANIM_STATUS_HPAL = cast(clong, &h00004004)
const MCI_ANIM_STATUS_STRETCH = cast(clong, &h00004005)
const MCI_ANIM_INFO_TEXT = cast(clong, &h00010000)
const MCI_ANIM_GETDEVCAPS_CAN_REVERSE = cast(clong, &h00004001)
const MCI_ANIM_GETDEVCAPS_FAST_RATE = cast(clong, &h00004002)
const MCI_ANIM_GETDEVCAPS_SLOW_RATE = cast(clong, &h00004003)
const MCI_ANIM_GETDEVCAPS_NORMAL_RATE = cast(clong, &h00004004)
const MCI_ANIM_GETDEVCAPS_PALETTES = cast(clong, &h00004006)
const MCI_ANIM_GETDEVCAPS_CAN_STRETCH = cast(clong, &h00004007)
const MCI_ANIM_GETDEVCAPS_MAX_WINDOWS = cast(clong, &h00004008)
const MCI_ANIM_REALIZE_NORM = cast(clong, &h00010000)
const MCI_ANIM_REALIZE_BKGD = cast(clong, &h00020000)
const MCI_ANIM_WINDOW_HWND = cast(clong, &h00010000)
const MCI_ANIM_WINDOW_STATE = cast(clong, &h00040000)
const MCI_ANIM_WINDOW_TEXT = cast(clong, &h00080000)
const MCI_ANIM_WINDOW_ENABLE_STRETCH = cast(clong, &h00100000)
const MCI_ANIM_WINDOW_DISABLE_STRETCH = cast(clong, &h00200000)
const MCI_ANIM_WINDOW_DEFAULT = cast(clong, &h00000000)
const MCI_ANIM_RECT = cast(clong, &h00010000)
const MCI_ANIM_PUT_SOURCE = cast(clong, &h00020000)
const MCI_ANIM_PUT_DESTINATION = cast(clong, &h00040000)
const MCI_ANIM_WHERE_SOURCE = cast(clong, &h00020000)
const MCI_ANIM_WHERE_DESTINATION = cast(clong, &h00040000)
const MCI_ANIM_UPDATE_HDC = cast(clong, &h00020000)
...
const MCI_OVLY_OPEN_WS = cast(clong, &h00010000)
const MCI_OVLY_OPEN_PARENT = cast(clong, &h00020000)
const MCI_OVLY_STATUS_HWND = cast(clong, &h00004001)
const MCI_OVLY_STATUS_STRETCH = cast(clong, &h00004002)
const MCI_OVLY_INFO_TEXT = cast(clong, &h00010000)
const MCI_OVLY_GETDEVCAPS_CAN_STRETCH = cast(clong, &h00004001)
const MCI_OVLY_GETDEVCAPS_CAN_FREEZE = cast(clong, &h00004002)
const MCI_OVLY_GETDEVCAPS_MAX_WINDOWS = cast(clong, &h00004003)
const MCI_OVLY_WINDOW_HWND = cast(clong, &h00010000)
const MCI_OVLY_WINDOW_STATE = cast(clong, &h00040000)
const MCI_OVLY_WINDOW_TEXT = cast(clong, &h00080000)
const MCI_OVLY_WINDOW_ENABLE_STRETCH = cast(clong, &h00100000)
const MCI_OVLY_WINDOW_DISABLE_STRETCH = cast(clong, &h00200000)
const MCI_OVLY_WINDOW_DEFAULT = cast(clong, &h00000000)
const MCI_OVLY_RECT = cast(clong, &h00010000)
const MCI_OVLY_PUT_SOURCE = cast(clong, &h00020000)
const MCI_OVLY_PUT_DESTINATION = cast(clong, &h00040000)
const MCI_OVLY_PUT_FRAME = cast(clong, &h00080000)
const MCI_OVLY_PUT_VIDEO = cast(clong, &h00100000)
const MCI_OVLY_WHERE_SOURCE = cast(clong, &h00020000)
const MCI_OVLY_WHERE_DESTINATION = cast(clong, &h00040000)
const MCI_OVLY_WHERE_FRAME = cast(clong, &h00080000)
const MCI_OVLY_WHERE_VIDEO = cast(clong, &h00100000)
