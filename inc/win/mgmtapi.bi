...
declare function SnmpMgrRequest(byval session as LPSNMP_MGR_SESSION, byval requestType as UBYTE, byval variableBindings as SnmpVarBindList ptr, byval errorStatus as AsnInteger32 ptr, byval errorIndex as AsnInteger32 ptr) as INT
