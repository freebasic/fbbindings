...
const SQL_NULL_HANDLE = cast(clong, 0)
...
const SQL_AT_ADD_COLUMN = cast(clong, &h00000001)
const SQL_AT_DROP_COLUMN = cast(clong, &h00000002)
const SQL_AT_ADD_CONSTRAINT = cast(clong, &h00000008)
const SQL_AM_NONE = 0
...
const SQL_FD_FETCH_NEXT = cast(clong, &h00000001)
const SQL_FD_FETCH_FIRST = cast(clong, &h00000002)
const SQL_FD_FETCH_LAST = cast(clong, &h00000004)
const SQL_FD_FETCH_PRIOR = cast(clong, &h00000008)
const SQL_FD_FETCH_ABSOLUTE = cast(clong, &h00000010)
const SQL_FD_FETCH_RELATIVE = cast(clong, &h00000020)
const SQL_GD_ANY_COLUMN = cast(clong, &h00000001)
const SQL_GD_ANY_ORDER = cast(clong, &h00000002)
const SQL_IC_UPPER = 1
const SQL_IC_LOWER = 2
const SQL_IC_SENSITIVE = 3
const SQL_IC_MIXED = 4
const SQL_OJ_LEFT = cast(clong, &h00000001)
const SQL_OJ_RIGHT = cast(clong, &h00000002)
const SQL_OJ_FULL = cast(clong, &h00000004)
const SQL_OJ_NESTED = cast(clong, &h00000008)
const SQL_OJ_NOT_ORDERED = cast(clong, &h00000010)
const SQL_OJ_INNER = cast(clong, &h00000020)
const SQL_OJ_ALL_COMPARISON_OPS = cast(clong, &h00000040)
const SQL_SCCO_READ_ONLY = cast(clong, &h00000001)
const SQL_SCCO_LOCK = cast(clong, &h00000002)
const SQL_SCCO_OPT_ROWVER = cast(clong, &h00000004)
const SQL_SCCO_OPT_VALUES = cast(clong, &h00000008)
const SQL_TC_NONE = 0
const SQL_TC_DML = 1
const SQL_TC_ALL = 2
const SQL_TC_DDL_COMMIT = 3
const SQL_TC_DDL_IGNORE = 4
const SQL_TXN_READ_UNCOMMITTED = cast(clong, &h00000001)
const SQL_TRANSACTION_READ_UNCOMMITTED = SQL_TXN_READ_UNCOMMITTED
const SQL_TXN_READ_COMMITTED = cast(clong, &h00000002)
const SQL_TRANSACTION_READ_COMMITTED = SQL_TXN_READ_COMMITTED
const SQL_TXN_REPEATABLE_READ = cast(clong, &h00000004)
const SQL_TRANSACTION_REPEATABLE_READ = SQL_TXN_REPEATABLE_READ
const SQL_TXN_SERIALIZABLE = cast(clong, &h00000008)
