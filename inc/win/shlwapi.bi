...
declare function SHStrDupA(byval psz as LPCSTR, byval ppwsz as WCHAR ptr ptr) as HRESULT
declare function SHStrDupW(byval psz as LPCWSTR, byval ppwsz as WCHAR ptr ptr) as HRESULT
