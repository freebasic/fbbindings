...
const RPC_CONTEXT_HANDLE_DEFAULT_FLAGS = cast(culong, &h00000000)
const RPC_CONTEXT_HANDLE_FLAGS = cast(culong, &h30000000)
const RPC_CONTEXT_HANDLE_SERIALIZE = cast(culong, &h10000000)
const RPC_CONTEXT_HANDLE_DONT_SERIALIZE = cast(culong, &h20000000)
...
const RPCFLG_MESSAGE = cast(culong, &h01000000)
const RPCFLG_AUTO_COMPLETE = cast(culong, &h08000000)
const RPCFLG_LOCAL_CALL = cast(culong, &h10000000)
const RPCFLG_INPUT_SYNCHRONOUS = cast(culong, &h20000000)
const RPCFLG_ASYNCHRONOUS = cast(culong, &h40000000)
const RPCFLG_NON_NDR = cast(culong, &h80000000)
const RPCFLG_HAS_MULTI_SYNTAXES = cast(culong, &h02000000)
const RPCFLG_HAS_CALLBACK = cast(culong, &h04000000)
