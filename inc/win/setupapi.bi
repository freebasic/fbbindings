...
const DI_SHOWOEM = cast(clong, &h00000001)
const DI_SHOWCOMPAT = cast(clong, &h00000002)
const DI_SHOWCLASS = cast(clong, &h00000004)
const DI_SHOWALL = cast(clong, &h00000007)
const DI_NOVCP = cast(clong, &h00000008)
const DI_DIDCOMPAT = cast(clong, &h00000010)
const DI_DIDCLASS = cast(clong, &h00000020)
const DI_AUTOASSIGNRES = cast(clong, &h00000040)
const DI_NEEDRESTART = cast(clong, &h00000080)
const DI_NEEDREBOOT = cast(clong, &h00000100)
const DI_NOBROWSE = cast(clong, &h00000200)
const DI_MULTMFGS = cast(clong, &h00000400)
const DI_DISABLED = cast(clong, &h00000800)
const DI_GENERALPAGE_ADDED = cast(clong, &h00001000)
const DI_RESOURCEPAGE_ADDED = cast(clong, &h00002000)
const DI_PROPERTIES_CHANGE = cast(clong, &h00004000)
const DI_INF_IS_SORTED = cast(clong, &h00008000)
const DI_ENUMSINGLEINF = cast(clong, &h00010000)
const DI_DONOTCALLCONFIGMG = cast(clong, &h00020000)
const DI_INSTALLDISABLED = cast(clong, &h00040000)
const DI_COMPAT_FROM_CLASS = cast(clong, &h00080000)
const DI_CLASSINSTALLPARAMS = cast(clong, &h00100000)
const DI_NODI_DEFAULTACTION = cast(clong, &h00200000)
const DI_QUIETINSTALL = cast(clong, &h00800000)
const DI_NOFILECOPY = cast(clong, &h01000000)
const DI_FORCECOPY = cast(clong, &h02000000)
const DI_DRIVERPAGE_ADDED = cast(clong, &h04000000)
const DI_USECI_SELECTSTRINGS = cast(clong, &h08000000)
const DI_OVERRIDE_INFFLAGS = cast(clong, &h10000000)
const DI_PROPS_NOCHANGEUSAGE = cast(clong, &h20000000)
const DI_NOSELECTICONS = cast(clong, &h40000000)
const DI_NOWRITE_IDS = cast(clong, &h80000000)
const DI_FLAGSEX_USEOLDINFSEARCH = cast(clong, &h00000001)
const DI_FLAGSEX_RESERVED2 = cast(clong, &h00000002)
const DI_FLAGSEX_CI_FAILED = cast(clong, &h00000004)
const DI_FLAGSEX_DIDINFOLIST = cast(clong, &h00000010)
const DI_FLAGSEX_DIDCOMPATINFO = cast(clong, &h00000020)
const DI_FLAGSEX_FILTERCLASSES = cast(clong, &h00000040)
const DI_FLAGSEX_SETFAILEDINSTALL = cast(clong, &h00000080)
const DI_FLAGSEX_DEVICECHANGE = cast(clong, &h00000100)
const DI_FLAGSEX_ALWAYSWRITEIDS = cast(clong, &h00000200)
const DI_FLAGSEX_PROPCHANGE_PENDING = cast(clong, &h00000400)
const DI_FLAGSEX_ALLOWEXCLUDEDDRVS = cast(clong, &h00000800)
const DI_FLAGSEX_NOUIONQUERYREMOVE = cast(clong, &h00001000)
const DI_FLAGSEX_USECLASSFORCOMPAT = cast(clong, &h00002000)
const DI_FLAGSEX_RESERVED3 = cast(clong, &h00004000)
const DI_FLAGSEX_NO_DRVREG_MODIFY = cast(clong, &h00008000)
const DI_FLAGSEX_IN_SYSTEM_SETUP = cast(clong, &h00010000)
const DI_FLAGSEX_INET_DRIVER = cast(clong, &h00020000)
const DI_FLAGSEX_APPENDDRIVERLIST = cast(clong, &h00040000)
const DI_FLAGSEX_PREINSTALLBACKUP = cast(clong, &h00080000)
const DI_FLAGSEX_BACKUPONREPLACE = cast(clong, &h00100000)
const DI_FLAGSEX_DRIVERLIST_FROM_URL = cast(clong, &h00200000)
const DI_FLAGSEX_RESERVED1 = cast(clong, &h00400000)
const DI_FLAGSEX_EXCLUDE_OLD_INET_DRIVERS = cast(clong, &h00800000)
const DI_FLAGSEX_POWERPAGE_ADDED = cast(clong, &h01000000)
const DI_FLAGSEX_FILTERSIMILARDRIVERS = cast(clong, &h02000000)
const DI_FLAGSEX_INSTALLEDDRIVER = cast(clong, &h04000000)
const DI_FLAGSEX_NO_CLASSLIST_NODE_MERGE = cast(clong, &h08000000)
const DI_FLAGSEX_ALTPLATFORM_DRVSEARCH = cast(clong, &h10000000)
const DI_FLAGSEX_RESTART_DEVICE_ONLY = cast(clong, &h20000000)
