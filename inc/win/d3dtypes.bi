...
const D3DRENDERSTATE_WRAPBIAS = cast(culong, 128)
const D3DWRAP_U = cast(clong, &h00000001)
const D3DWRAP_V = cast(clong, &h00000002)
const D3DWRAPCOORD_0 = cast(clong, &h00000001)
const D3DWRAPCOORD_1 = cast(clong, &h00000002)
const D3DWRAPCOORD_2 = cast(clong, &h00000004)
const D3DWRAPCOORD_3 = cast(clong, &h00000008)
...
const D3DPROCESSVERTICES_TRANSFORMLIGHT = cast(clong, &h00000000)
const D3DPROCESSVERTICES_TRANSFORM = cast(clong, &h00000001)
const D3DPROCESSVERTICES_COPY = cast(clong, &h00000002)
const D3DPROCESSVERTICES_OPMASK = cast(clong, &h00000007)
const D3DPROCESSVERTICES_UPDATEEXTENTS = cast(clong, &h00000008)
const D3DPROCESSVERTICES_NOCOLOR = cast(clong, &h00000010)
...
const D3DTRIFLAG_START = cast(clong, &h00000000)
#define D3DTRIFLAG_STARTFLAT(len) (len)
const D3DTRIFLAG_ODD = cast(clong, &h0000001e)
const D3DTRIFLAG_EVEN = cast(clong, &h0000001f)
const D3DTRIFLAG_EDGEENABLE1 = cast(clong, &h00000100)
const D3DTRIFLAG_EDGEENABLE2 = cast(clong, &h00000200)
const D3DTRIFLAG_EDGEENABLE3 = cast(clong, &h00000400)
...
const D3DSETSTATUS_STATUS = cast(clong, &h00000001)
const D3DSETSTATUS_EXTENTS = cast(clong, &h00000002)
...
const D3DCLIPSTATUS_STATUS = cast(clong, &h00000001)
const D3DCLIPSTATUS_EXTENTS2 = cast(clong, &h00000002)
const D3DCLIPSTATUS_EXTENTS3 = cast(clong, &h00000004)
...
const D3DEXECUTE_CLIPPED = cast(clong, &h00000001)
const D3DEXECUTE_UNCLIPPED = cast(clong, &h00000002)
...
const D3DVBCAPS_SYSTEMMEMORY = cast(clong, &h00000800)
const D3DVBCAPS_WRITEONLY = cast(clong, &h00010000)
const D3DVBCAPS_OPTIMIZED = cast(clong, &h80000000)
const D3DVBCAPS_DONOTCLIP = cast(clong, &h00000001)
